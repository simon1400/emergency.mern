...
"gt gte lt lte ne in nin all regex size maxDistance minDistance"
  ...
  .forEach(function($conditional) {
    Query.prototype[$conditional] = function() {
      ...
      var conds =
        this._conditions[path] === null ||
        typeof this._conditions[path] === "object"
...
Query.prototype.geometry = function geometry() {
  if (
    ...
    throw new Error(
      "geometry() must come after `within()`, `intersects()`, or `near()"
    );
  }
...
Query.prototype.select = function select() {
  ...
  if (
    (("string" == type || utils.isArgumentsObject(arg)) &&
...
function _pushMap(opts, map) {
  ...
  if (!(opts.sort instanceof Map)) {
    throw new TypeError(
      "Can't mix sort syntaxes. Use either array or " +
...
Query.prototype.writeConcern = Query.prototype.w = function writeConcern(
  concern
) {
...
Query.prototype.distinct = function(criteria, field, callback) {
  ...
  if (!callback) {
    switch (typeof field) {
      ...
      default:
        throw new TypeError(
          "Invalid `field` argument. Must be string or function"
        );
    }
...
Query.prototype.updateMany = function updateMany(
  criteria,
  doc,
  options,
  callback
...
Query.prototype.updateOne = function updateOne(
  criteria,
  doc,
  options,
  callback
...
Query.prototype.replaceOne = function replaceOne(
  criteria,
  doc,
  options,
  callback
...
Query.prototype._wrapCallback = function(method, callback, queryInfo) {
  ...
  if (traceFunction) {
    ...
    var traceCallback =
      traceFunction && traceFunction.call(null, method, queryInfo, this);
