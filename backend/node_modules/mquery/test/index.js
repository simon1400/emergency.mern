...
describe("mquery", function() {
  ...
  "gt gte lt lte ne in nin regex size maxDistance minDistance"
    .split(" ")
    ...
    describe("when called with arguments", function() {
      ...
      describe("of length 1", function() {
        ...
        it("delegates to box when exists", function() {
          var m = mquery()
            .where("loc")
            .within({ box: [[10, 10], [11, 14]] });
          assert.deepEqual(
            { $geoWithin: { $box: [[10, 10], [11, 14]] } },
            m._conditions.loc
          );
        });
        it("delegates to polygon when exists", function() {
          var m = mquery()
            .where("loc")
            .within({ polygon: [[10, 10], [11, 14], [10, 9]] });
          assert.deepEqual(
            { $geoWithin: { $polygon: [[10, 10], [11, 14], [10, 9]] } },
            m._conditions.loc
          );
        });
      ...
      describe("of length > 2", function() {
        it("delegates to polygon()", function() {
          var m = mquery()
            .where("loc")
            .within([1, 2], [2, 5], [2, 4], [1, 3]);
          assert.deepEqual(m._conditions.loc, {
            $geoWithin: { $polygon: [[1, 2], [2, 5], [2, 4], [1, 3]] }
          });
        });
      });
    });
      ...
      describe("of length > 2", function() {
        it("delegates to polygon()", function() {
          var m = mquery()
            ...
            .within([1, 2], [2, 5], [2, 4], [1, 3]);
          assert.deepEqual(m._conditions.loc, {
            $within: { $polygon: [[1, 2], [2, 5], [2, 4], [1, 3]] }
          });
        });
      });
    });
    ...
    describe("when first argument is not a string", function() {
      ...
      it("assigns arguments to within polygon condition", function() {
        var m = mquery()
          ...
          .polygon([1, 2], [2, 3], [3, 6]);
        assert.deepEqual(m._conditions, {
          loc: { $geoWithin: { $polygon: [[1, 2], [2, 3], [3, 6]] } }
        });
      });
    });
      ...
      describe("after intersects()", function() {
        it("and arg quacks like geoJSON", function(done) {
          var m = mquery()
            ...
            .geometry(point);
          assert.deepEqual(
            { a: { $geoIntersects: { $geometry: point } } },
            m._conditions
          );
          done();
        });
  ...
  describe("sort", function() {
    ...
    it("works with maps", function() {
      ...
      assert.deepEqual(
        query.options.sort,
        new Map().set("field", 1).set("test", -1)
      );
    });
  });
  ...
  describe("update", function() {
    ...
    describe("executes", function() {
      var id;
      before(function(done) {
        col.insert({ name: "mquery update", age: 1 }, { safe: true }, function(
          err,
          res
        ) {
  ...
  describe("findOneAndUpdate", function() {
    ...
    describe("with 2 args", function() {
      ...
      it("update + callback", function(done) {
        ...
        m.findOneAndUpdate({}, { $inc: { age: 10 } }, { new: true }, function(
          err,
          res
        ) {
          assert.ifError(err);
  ...
  describe("findOneAndRemove", function() {
    ...
    describe("with 3 args", function() {
      it("conditions + options + callback", function(done) {
        ...
        col.insert([{ name: name }, { name: "a" }], { safe: true }, function(
          err
        ) {
          assert.ifError(err);
          var m = mquery(col);
          m.findOneAndRemove({ name: name }, { sort: { name: 1 } }, function(
            err,
            res
          ) {
            assert.ifError(err);
  ...
  describe("stream", function() {
    before(function(done) {
      col.insert(
        [{ name: "stream", age: 1 }, { name: "stream", age: 2 }],
        done
      );
    });
