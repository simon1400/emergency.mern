  ...
  describe("get", function() {
    ...
    describe("without `special`", function() {
      ...
      it("handles array.array.index.prop", function(done) {
        ...
        assert.deepEqual([{ c: 48 }, undefined], mpath.get("arr.arr.1.a", o));
        mpath.set("arr.arr.1.a", [{ c: 49 }, undefined], o);
        assert.deepEqual([{ c: 49 }, undefined], mpath.get("arr.arr.1.a", o));
    ...
    describe("with `special`", function() {
      describe("that is a string", function() {
        ...
        it("handles array.array.index.array.prop", function(done) {
          ...
          assert.deepEqual(
            ["nil", "nil", [2]],
            mpath.get("comments.comments.1.comments.val", o, special, function(
              v
            ) {
      ...
      describe("that is a function", function() {
        ...
        it("works", function(done) {
          ...
          assert.deepEqual(
            "twoo",
            mpath.get("comments.8.comments.1.comments.0.val", o, function(
              obj,
              path
            ) {
  ...
  describe("set", function() {
    ...
    describe("with `special`", function() {
      ...
      describe("array.array.index.path", function() {
        ...
        it("with array", function(done) {
          mpath.set("arr.arr.0.a", [4, 8, 15, 16, 23, 42], o, special, function(
            v
          ) {
            return v * 2;
          });
