...
Query.prototype.select = function select() {
  ...
  const userProvidedFields =
    this._userProvidedFields || (this._userProvidedFields = {});
...
Query.prototype._countDocuments = wrapThunk(function(callback) {
  ...
  this._collection.collection.countDocuments(
    conds,
    options,
    utils.tick(callback)
  );
...
Query.prototype._estimatedDocumentCount = wrapThunk(function(callback) {
  ...
  this._collection.collection.estimatedDocumentCount(
    options,
    utils.tick(callback)
  );
});
...
Query.prototype.__distinct = wrapThunk(function __distinct(callback) {
  ...
  // don't pass in the conditions because we already merged them in
  this._collection.collection.distinct(
    this._distinct,
    this._conditions,
    callback
  );
...
Query.prototype._remove = wrapThunk(function(callback) {
  ...
  return Query.base.remove.call(
    this,
    helpers.handleDeleteWriteOpResult(callback)
  );
});
...
Query.prototype._deleteOne = wrapThunk(function(callback) {
  ...
  return Query.base.deleteOne.call(
    this,
    helpers.handleDeleteWriteOpResult(callback)
  );
});
...
Query.prototype._deleteMany = wrapThunk(function(callback) {
  ...
  return Query.base.deleteMany.call(
    this,
    helpers.handleDeleteWriteOpResult(callback)
  );
});
...
function prepareDiscriminatorCriteria(query) {
  ...
  if (
    ...
    !schema.discriminatorMapping.isRoot
  ) {
    query._conditions[schema.discriminatorMapping.key] =
...
Query.prototype._findAndModify = function(type, callback) {
  ...
  if (useFindAndModify === false) {
    ...
    const updateMethod = isOverwriting
      ? "findOneAndReplace"
      : "findOneAndUpdate";
...
const _legacyFindAndModify = util.deprecate(function(filter, update, opts, cb) {
  ...
  collection.findAndModify(
    ...
    update,
    opts,
    _wrapThunkCallback(this, function(error, res) {
      return cb(error, res ? res.value : res, res);
    })
  );
