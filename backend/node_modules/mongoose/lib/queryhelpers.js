...
exports.preparePopulationOptions = function preparePopulationOptions(
  query,
  options
) {
...
exports.preparePopulationOptionsMQ = function preparePopulationOptionsMQ(
  query,
  options
) {
...
exports.createModel = function createModel(
  ...
  const key =
    discriminatorMapping && discriminatorMapping.isRoot
  ...
  if (key && value && model.discriminators) {
    const discriminator =
      model.discriminators[value] || getDiscriminatorByValue(model, value);
    if (discriminator) {
...
exports.handleDeleteWriteOpResult = function handleDeleteWriteOpResult(
  callback
) {
