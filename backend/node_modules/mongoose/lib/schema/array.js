...
SchemaArray.prototype.enum = function() {
  ...
  if (instance !== "String") {
    throw new Error(
      "`enum` can only be set on an array of strings, not " + instance
    );
  }
...
function cast$elemMatch(val) {
  ...
  const discriminators = get(
    this,
    "casterConstructor.schema.discriminators",
    {}
  );
  if (
...
handle.$eq = handle.$gt = handle.$gte = handle.$lt = handle.$lte = handle.$ne = handle.$nin = handle.$regex =
