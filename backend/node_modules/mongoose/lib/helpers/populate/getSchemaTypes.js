    ...
    while (p--) {
      ...
      if (foundschema.caster) {
        ...
        if (
          ...
          foundschema.schema.discriminators != null
        ) {
          const discriminators = foundschema.schema.discriminators;
          const discriminatorKeyPath =
            trypath + "." + foundschema.schema.options.discriminatorKey;
          const keys = subdoc
            ? mpath.get(discriminatorKeyPath, subdoc) || []
            : [];
          schemas = Object.keys(discriminators).reduce(function(
            cur,
            discriminator
          ) {
      ...
      if (
        topLevelDoc.$__ &&
        topLevelDoc.populated(fullPath) &&
        p < parts.length
      ) {
        ...
        if (schema != null) {
          ...
          if (ret) {
            ret.$isUnderneathDocArray =
              ret.$isUnderneathDocArray || !schema.$isSingleNested;
          }
      ...
      if (_val != null) {
        const model =
          Array.isArray(_val) && _val.length > 0
