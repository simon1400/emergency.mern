...
NativeCollection.prototype.onOpen = function() {
  ...
  return _this.conn.db.collection(_this.name, function(err, c) {
    ...
    _this.conn.db
      .listCollections({ name: _this.name })
      .toArray(function(err, docs) {
        ...
        if (exists) {
          if (doc.options && doc.options.capped) {
            ...
            const msg =
              "A non-capped collection exists with the name: " +
              _this.name +
              "\n\n" +
...
NativeCollection.prototype.getIndexes =
  NativeCollection.prototype.indexInformation;
