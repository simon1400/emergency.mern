...
test("stringify()", function(t) {
    ...
    t.test("stringifies an array with mixed objects and primitives", function(
        st
    ) {
        st.equal(
            qs.stringify(
    ...
    t.test("stringifies an object inside an array with dots notation", function(
        st
    ) {
        st.equal(
            qs.stringify(
    ...
    t.test("skips properties that are part of the object prototype", function(
        st
    ) {
    ...
    t.test("stringifies an object using an alternative delimiter", function(
        st
    ) {
        st.equal(
    ...
    t.test("supports custom representations when filter=function", function(
        st
    ) {
        var calls = 0;
