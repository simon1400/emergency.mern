  ...
  switch (typeof value) {
    ...
    case "number":
      if (
        ...
        if (value >= BSON.BSON_INT32_MIN && value <= BSON.BSON_INT32_MAX) {
          // 32 bit
          return (
            (name != null ? Buffer.byteLength(name, "utf8") + 1 : 0) + (4 + 1)
          );
        } else {
          return (
            (name != null ? Buffer.byteLength(name, "utf8") + 1 : 0) + (8 + 1)
          );
        }
      } else {
        // 64 bit
    ...
    case "object":
      if (
        ...
        return (
          (name != null ? Buffer.byteLength(name, "utf8") + 1 : 0) + (12 + 1)
        );
        ...
        return (
          (name != null ? Buffer.byteLength(name, "utf8") + 1 : 0) + (16 + 1)
        );
