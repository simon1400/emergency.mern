...
Store.prototype.add = function(opType, ns, ops, options, callback) {
  if (this.s.storeOptions.force) {
    return callback(
      MongoError.create({ message: "db closed by application", driver: true })
    );
  }
...
Store.prototype.addObjectAndMethod = function(
  opType,
  object,
  method,
  params,
...
Store.prototype.execute = function(options) {
  ...
  var executeSecondary =
    typeof options.executeSecondary === "boolean"
...
class TopologyBase extends EventEmitter {
  ...
  capabilities() {
    ...
    this.s.sCapabilities = new ServerCapabilities(
      this.s.coreTopology.lastIsMaster()
    );
