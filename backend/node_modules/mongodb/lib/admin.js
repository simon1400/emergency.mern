...
Admin.prototype.serverStatus = function(options, callback) {
  ...
  return executeOperation(this.s.db.s.topology, serverStatus, [
    this,
    options,
    callback
  ]);
 ...
 * @return {Promise} returns Promise if no callback passed
 */
Admin.prototype.validateCollection = function(
  collectionName,
  options,
  callback
) {
...
Admin.prototype.replSetGetStatus = function(options, callback) {
  ...
  return executeOperation(this.s.db.s.topology, replSetGetStatus, [
    this,
    options,
    callback
  ]);
