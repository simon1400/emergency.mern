...
var Chunk = function(file, mongoObject, writeConcern) {
  ...
  this.objectId =
    mongoObjectFinal._id == null ? new ObjectID() : mongoObjectFinal._id;
  ...
  if (typeof mongoObjectFinal.data === "string") {
    ...
    buffer.write(
      mongoObjectFinal.data,
      0,
      mongoObjectFinal.data.length,
      "binary"
    );
    ...
    mongoObjectFinal.data &&
    mongoObjectFinal.data._bsontype === "Binary"
  ) {
    this.data = mongoObjectFinal.data;
  } else if (
    !Buffer.isBuffer(mongoObjectFinal.data) &&
    !(mongoObjectFinal.data == null)
  ) {
