...
Query.prototype.toBin = function() {
  ...
  if (
    self.returnFieldSelector &&
    Object.keys(self.returnFieldSelector).length > 0
  ) {
...
var Response = function(bson, message, msgHeader, msgBody, opts) {
  ...
  this.promoteLongs =
    typeof opts.promoteLongs === "boolean" ? opts.promoteLongs : true;
  this.promoteValues =
    typeof opts.promoteValues === "boolean" ? opts.promoteValues : true;
  this.promoteBuffers =
    typeof opts.promoteBuffers === "boolean" ? opts.promoteBuffers : false;
};
