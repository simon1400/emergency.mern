...
const MESSAGE_HEADER_SIZE = require("../wireprotocol/shared")
  .MESSAGE_HEADER_SIZE;
const COMPRESSION_DETAILS_SIZE = require("../wireprotocol/shared")
...
function serializeCommand(self, command, callback) {
  ...
  const concatenatedOriginalCommandBuffer = Buffer.concat(
  ...
  compress(self, messageToBeCompressed, function(err, compressedMessage) {
    ...
    compressionDetails.writeUInt8(
      compressorIDs[self.options.agreedCompressor],
      8
    ); // compressorID
