  ...
  constructor(
    ...
    for (const serverDescription of this.servers.values()) {
      ...
      if (serverDescription.minWireVersion > MAX_SUPPORTED_WIRE_VERSION) {
        ...
        this.compatibilityError = `Server at ${
          serverDescription.address
        } requires wire version ${
...
function updateRsFromPrimary(
  ...
  const electionIdOID = serverDescription.electionId
    ? serverDescription.electionId.$oid
    : null;
  ...
  if (serverDescription.setVersion != null && electionIdOID != null) {
    if (maxSetVersion != null && maxElectionIdOID != null) {
      if (
        ...
        maxElectionIdOID > electionIdOID
      ) {
