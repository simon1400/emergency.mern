  ...
  Object.assign(queryOptions, {
    ...
    promoteBuffers:
      typeof options.promoteBuffers === "boolean"
        ...
        : false,
    monitoring:
      typeof options.monitoring === "boolean" ? options.monitoring : false,
    fullResult:
...
function isSharded(topologyOrServer) {
  ...
  if (
    ...
    topologyOrServer.description.type === ServerType.Mongos
  ) {
    return true;
  }
  ...
  if (
    topologyOrServer.description &&
    topologyOrServer.description instanceof TopologyDescription
  ) {
