...
var BROKEN_CLASSOF =
  classof(require("../internals/object-create")(NumberPrototype)) == NUMBER;
  ...
  var NumberWrapper = function Number(value) {
    ...
    return that instanceof NumberWrapper &&
      ...
      (BROKEN_CLASSOF
        ...
        : classof(that) != NUMBER)
      ? inheritIfRequired(new NativeNumber(toNumber(it)), that, NumberWrapper)
      : toNumber(it);
  };
  for (
    var keys = require("../internals/descriptors")
