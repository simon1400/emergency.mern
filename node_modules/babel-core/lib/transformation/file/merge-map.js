...
function mergeSourceMap(inputMap, map) {
  ...
  if (output.sources.length === 1) {
    ...
    eachInputGeneratedRange(input, function(generated, original, source) {
      eachOverlappingGeneratedOutputRange(defaultSource, generated, function(
        item
      ) {
...
function buildMappingData(map) {
  var consumer = new _sourceMap2.default.SourceMapConsumer(
    (0, _extends3.default)({}, map, {
      sourceRoot: null
    })
  );
  ...
  consumer.eachMapping(
    ...
    null,
    _sourceMap2.default.SourceMapConsumer.ORIGINAL_ORDER
  );
