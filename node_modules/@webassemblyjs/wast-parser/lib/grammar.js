...
function parse(tokensList, source) {
  ...
  function walk() {
    ...
    function parseMemory() {
      ...
      if (
        token.type === _tokenizer.tokens.string ||
        token.type === _tokenizer.tokens.identifier
      ) {
      ...
      if (
        lookaheadAndCheck(_tokenizer.tokens.openParen, _tokenizer.keywords.data)
      ) {
        eatToken(); // (
      ...
      if (
        lookaheadAndCheck(
          _tokenizer.tokens.openParen,
          _tokenizer.keywords.export
        )
      ) {
        eatToken(); // (
    ...
    function parseFuncInstr() {
      ...
      if (
        ...
        isKeyword(token, _tokenizer.keywords.module) &&
        hasPlugin("wast")
      ) {
    ...
    function parseType() {
      ...
      if (
        lookaheadAndCheck(_tokenizer.tokens.openParen, _tokenizer.keywords.func)
      ) {
        eatToken(); // (
