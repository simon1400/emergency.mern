...
function decode(ab, opts) {
  ...
  function readF64() {
    ...
    if (isNaN(value)) {
      ...
      mantissa +=
        (bytes[bytes.length - 2] % 16) * Math.pow(256, bytes.length - 2);
      return {
        value: sign * mantissa,
        nan: true,
        nextIndex: ieee754.NUMBER_OF_BYTE_F64
  ...
  function readF32() {
    ...
    if (isNaN(value)) {
      ...
      mantissa +=
        (bytes[bytes.length - 2] % 128) * Math.pow(256, bytes.length - 2);
      return {
        value: sign * mantissa,
        nan: true,
        nextIndex: ieee754.NUMBER_OF_BYTE_F32
  ...
  function parseModuleHeader() {
    ...
    if (
      byteArrayEq(_helperWasmBytecode.default.magicModuleHeader, header) ===
      false
    ) {
  ...
  function parseVersion() {
    ...
    if (
      byteArrayEq(_helperWasmBytecode.default.moduleVersion, version) === false
    ) {
  ...
  function parseExportSection(numberOfExport) {
    ...
    for (var i = 0; i < numberOfExport; i++) {
      ...
      if (_helperWasmBytecode.default.exportTypes[typeIndex] === "Func") {
        ...
        _helperWasmBytecode.default.exportTypes[typeIndex] === "Table"
      ) {
        ...
        _helperWasmBytecode.default.exportTypes[typeIndex] === "Global"
      ) {
  ...
  function parseInstructionBlock(code) {
    while (true) {
      ...
      var instruction =
        _helperWasmBytecode.default.symbolsByByte[instructionByte];
      ...
      if (instruction.name === "loop") {
        ...
        eatBytes(1);
        var _blocktype2 =
          _helperWasmBytecode.default.blockTypes[_blocktypeByte2];
  ...
  function parseSection(sectionIndex) {
    ...
    if (
      ...
      sectionIndex === _helperWasmBytecode.default.sections.custom
    ) {
    ...
    switch (sectionId) {
      ...
      case _helperWasmBytecode.default.sections.data: {
        ...
        if (opts.ignoreDataSection === true) {
          var _remainingBytes =
            sectionSizeInBytes - _numberOfElementsu2.nextIndex;
