...
var _stringToObjectStyle = _interopRequireDefault(
  require("./stringToObjectStyle")
);
...
function getKey(key, value, node) {
  ...
  const mappedElementAttribute =
    _mappings.ELEMENT_ATTRIBUTE_MAPPING[node.name] &&
    _mappings.ELEMENT_ATTRIBUTE_MAPPING[node.name][lowerCaseKey];
