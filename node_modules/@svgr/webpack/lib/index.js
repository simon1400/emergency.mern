...
var _pluginTransformReactConstantElements = _interopRequireDefault(
...
const babelOptions = {
  ...
  configFile: false,
  presets: [
    (0, _core.createConfigItem)(_presetReact.default, {
      type: "preset"
    }),
  ...
  plugins: [
    (0, _core.createConfigItem)(_pluginTransformReactConstantElements.default)
  ]
};
