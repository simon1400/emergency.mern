  ...
  })(
    {
        ...
        function(e, r, t) {
          ...
          r.exports = function u(e, c, h, r) {
            var f = this,
              ...
              a = {},
              g = [];
            c = c || { schema: e, refVal: d, refs: m };
            var s = L.call(this, e, c, r);
            ...
            function w(e, r, t, a) {
              ...
              if (r.schema != c.schema) return u.call(f, e, r, t, a);
              var o,
                i = !0 === e.$async,
                n = I({
                  isTop: !0,
            ...
            function R(e, r, t, a) {
              ...
              if (u) l = u.call(f, r, t, a);
              else if (h)
                (l = h.call(f, r, t, a)),
                  !1 !== p.validateSchema && f.validateSchema(l, !0);
              else if (c) l = c.call(f, a, e.keyword, r, t);
              ...
              if ("all" == R) a += " delete " + c + "[" + m + "]; ";
                ...
                if (
                  ...
                  if ("failing" == R) {
                    ...
                    var M = e.validate(d);
                    (d.baseId = j),
                      e.util.varOccurences(M, g) < 2
                        ? (a += " " + e.util.varReplace(M, g, H) + " ")
                        : (a += " var " + g + " = " + H + "; " + M + " "),
                      (a +=
                        " if (!" +
                        p +
              ...
              if (B)
                for (var J, Z = -1, G = B.length - 1; Z < G; ) {
                  if (
                    ...
                    M = e.validate(d);
                    if (((d.baseId = j), e.util.varOccurences(M, g) < 2)) {
                      M = e.util.varReplace(M, g, H);
                      var X = H;
                    } else {
                      X = g;
                      a += " var " + g + " = " + H + "; ";
      ...
      37: [
        function(e, r, t) {
          ...
          r.exports = function(a, e, r) {
            ...
            if (a.isTop) {
              var g = a.isTop;
              (u = a.level = 0), (c = a.dataLevel = 0), (m = "data");
              if (
            ...
            if (
              (S &&
                ...
                !0 === a.schema.nullable &&
                (b
                  ? -1 == S.indexOf("null") && (S = S.concat("null"))
                  : "null" != S && ((S = [S, "null"]), (b = !0))),
              b && 1 == S.length && ((S = S[0]), (b = !1)),
              a.schema.$ref && o)
            ) {
            ...
            if (
              ...
              if (a.opts.coerceTypes)
                var _ = a.util.coerceToTypes(a.opts.coerceTypes, S);
              var F = a.RULES.types[S];
              if (_ || b || !0 === F || (F && !Y(F))) {
                (d = a.schemaPath + ".type"),
                ...
                if (
                  ((t +=
                    " if (" +
                    a.util[b ? "checkDataTypes" : "checkDataType"](S, m, !0) +
                    ") { "),
                  _)
                ) {
                  var x = "dataType" + u,
                  ...
                  if (Y((F = C[(k += 1)]))) {
                    ...
                    if (M)
                      for (var K, B = -1, J = M.length - 1; B < J; )
                        if (W((K = M[(B += 1)]))) {
                          var Z = K.code(a, K.keyword, F.type);
                          Z && ((t += " " + Z + " "), p && (E += "}"));
                        }
                    if (
                      (p && ((t += " " + E + " "), (E = "")),
                      F.type && ((t += " } "), S && S === F.type && !_))
                    ) {
                      var G;
                      (d = a.schemaPath + ".type"),
                        (f = a.errSchemaPath + "/type");
      ...
      38: [
        function(e, r, t) {
          ...
          var i = /^[a-z_$][a-z0-9_$-]*$/i,
            l = e("./dotjs/custom"),
            a = e("./refs/json-schema-draft-07.json");
          r.exports = {
            add: function(e, r) {
              var n = this.RULES;
              if (n.keywords[e])
      ...
      ajv: [
        function(a, e, r) {
          ...
          var c = a("./keyword");
          (y.prototype.addKeyword = c.add),
            (y.prototype.getKeyword = c.get),
            (y.prototype.removeKeyword = c.remove),
            (y.prototype.validateKeyword = c.validate);
