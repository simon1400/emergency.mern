(function(global, factory) {
  ...
  pp$1.parseTopLevel = function(node) {
    ...
    if (this.inModule) {
      for (
        var i = 0, list = Object.keys(this$1.undefinedExports);
        i < list.length;
        i += 1
      ) {
        var name = list[i];
        ...
        this$1.raiseRecoverable(
          this$1.undefinedExports[name].start,
  ...
  pp$3.parseSubscripts = function(base, startPos, startLoc, noCalls) {
    ...
    while (true) {
      var element = this$1.parseSubscript(
        base,
        startPos,
        startLoc,
        noCalls,
    ...
    if (bindingType === BIND_LEXICAL) {
      ...
      for (var i = this.scopeStack.length - 1; i >= 0; --i) {
        ...
        if (
          ...
          (!this$1.treatFunctionsAsVarInScope(scope$3) &&
