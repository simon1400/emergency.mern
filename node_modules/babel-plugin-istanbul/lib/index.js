...
var _babelPluginSyntaxObjectRestSpread2 = _interopRequireDefault(
  _babelPluginSyntaxObjectRestSpread
);
...
function makeShouldSkip() {
  ...
  return function shouldSkip(file, opts) {
    if (!exclude) {
      ...
      var nycConfig = process.env.NYC_CONFIG
      ...
      if (Object.keys(opts).length > 0) {
        ...
        config = {
          ...
          configPath: (0, _path.dirname)(
            findUp.sync("package.json", { cwd: cwd })
          )
        };
      }
